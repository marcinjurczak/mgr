...
// TODO opisać programowanie funkcyjne
...
Po prawidłowym złączeniu wszystkich fragmentów kodu program powinien się kompilować i wyświetlać nowy pasek pola tekstowego, a po wciśnięciu klawisza Enter strona powinna został przekierowana do wyszukiwarki Google.
...
\begin{lstlisting}
  $ elm make src/MainBookmarks.elm --output=elm.js
\end{lstlisting}
...
W tym celu należy odpowiednio zmienić w programie funkcje odpowiedzialne za wyświetlanie
