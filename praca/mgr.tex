...
Na potrzeby aplikacji postanowiłem zaimplementować następujące funkcjonalności:
\begin{itemize}[noitemsep,topsep=0pt]
...
\section{Model}
Poniżej, w listingu~\ref{lst:impl_model} przedstawiam zaimplementowany model aplikacji, którego celem jest reprezentacja aktualnego stanu aplikacji, a także pokazuję stworzone typy pomocniczne wykorzystane w głównym typie Model.
