...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Przykłady wartości w Elmie}\label{fig:repl_values}
\end{figure}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \includegraphics[width=0.5\textwidth]{repl_func}
    \caption{Przykładowa funkcja w Elmie}\label{fig:repl_func}
\end{wrapfigure}
...
\begin{figure}[H]
    ...
    \caption{Komunikar kompilatora o błędzie}\label{fig:repl_error}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Przykładowe operacje na listach}\label{fig:repl_lists}
\end{figure}
