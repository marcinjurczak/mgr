...
Jednakże w porównaniu do Angulara jest to bardzo lekkie rozwiązanie umożliwiające progrmiście dużo więcej swobody w tworzeniu aplikacji.
Angular zdecydowanie bardziej wymusza na użytkowniku pewne rozwiązania architektoniczne, gdzie w Vue jest to jak najbardziej możliwe, ale nie koniczne.
...
Następnie wiadomość jest odpowiednio przetworzana przez funkcję \texttt{update} i w wyniku aktualna strona zostaje przekierowana do wyszukiwarki wraz z aktualnym stanem modelu, czyli wartością \texttt{searchText}.
